...
"""
These all remain the same as the vanilla DDPM
...
# "ConditionalEmbedding" This is something new here in the conditional DDPM as compared to the vanilla DDPM
#  This controls how the condition is injected into the "ResBlock". 
#  This converts class lables into vectors.

class ConditionalEmbedding(nn.Module): #reminder : CIFAR 10 has 10 classes
...
class DownSample(nn.Module):
    ...
    # 3×3 convolution captures smaller local patterns
    # 5×5 convolution captures slightly wider patterns
